...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($error_message)) {
		foreach ($_POST as $value) {
			if ( stripos($value,'Content-Type:') !== FALSE ) {
				$error_message = "There was a problem with the information you provide.";
			}
		}
	}
	...
	if (!isset($error_message)) {
		...
		$address = "likhon2093@gmail.com";
		$mail->AddAddress($address, "Leaf Online Store");
		$mail->Subject = "Leaf Online Store | " . $name;
	...
	<div class="wrapper">
		...
		<div class="main-page">
			...
			<?php if (isset($_GET["status"]) AND $_GET["status"] == "thanks") { ?>
					<p>Thank you for your email. We&rsquo;ll be in touch with you shortly.</p>
			<?php } else { ?>
